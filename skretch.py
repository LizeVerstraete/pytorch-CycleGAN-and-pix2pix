...
labels = torch.randint(0, 256, (4,412,412,3), dtype=torch.uint8)
predictions = torch.randint(0, 256, (4,412,412,3), dtype=torch.uint8)

unpaired_lab_WB(labels.reshape(-1, 412, 3).unsqueeze(0),predictions.reshape(-1, 412, 3).unsqueeze(0))
